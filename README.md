...
2) Either
   a) download the prawns.zip file and extract this inside a folder named "data" inside your working directory, such that the photos are in ./data/prawns . If your folder structure is different, you can change line 11 of prawncolour.py to ensure that the script can find your photos.
